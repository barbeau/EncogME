...
public final class MatrixCODEC {
	...
	public static Double[] networkToArray(final BasicNetwork network) {
		...
		//for (final Layer layer : network.getLayers()) {
        Enumeration e2 = network.getLayers().elements();  //sjb - changed to support Vectors
        while(e2.hasMoreElements()){  //sjb - changed to support Vectors
            Layer layer = (Layer) e2.nextElement();  //sjb - changed to support Vectors, cast Object
